...
from optimizers.dpnsgd_optimizer import DPNSGD_Optimizer
from torch import optim


class DPNSGDPrivacyEngine(PrivacyEngine):
    """
     This class defines the customized privacy engine for DPNSGD.
    ...
    def _prepare_optimizer(
        ...
        optimizer = DPNSGD_Optimizer(optimizer=optimizer,
